...
{    
     ...
     //selecting data for the different signal regions
     ...
     //selecting data for the validation regions
     ...
     //Creating decay channels for the signal regions
     ...
     //Creating decay channels for the validation regions
     ...
     VariableDistr *var_nlep = new VariableDistr("nSigLep","nSigLep","nSigLep","Events",10,-10,10,true); 
     ...
     //Adding decay channels for the signal regions to the analyzer    
     ...
     //Adding decay channels for the validation regions to the analyzer 
    ...
    //=====================================================================================
    //Getting out values: Just to show in the terminal (for practical reasons)
